...
ax[1].plot(rm_segment, Krad[rm_segment], label=('Pr = '+str(Krad[rm_segment])), c='g')
ax[1].plot(rm_segment, Ktang[rm_segment], label=('Pt = '+str(round(Ktang[rm_segment],1))), c='m')
ax[1].plot(rm_segment, Kschub[rm_segment], label=('Ps = '+str(round(Kschub[rm_segment],1))), c='k)
